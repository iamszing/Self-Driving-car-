...
class DQN():
	...
	def update(self, reward, new_signal):
		...
		if len(self.memory.memory) >100:
			self,batch_state , batch_next_state,batch_reward, batch_action =self.memory.sample(100)
			self.learn(self,batch_state , batch_next_state,batch_reward, batch_action)
